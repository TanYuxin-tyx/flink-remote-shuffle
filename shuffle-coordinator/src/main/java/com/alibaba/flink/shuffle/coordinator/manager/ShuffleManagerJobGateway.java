...
public interface ShuffleManagerJobGateway extends RemoteShuffleFencedRpcGateway<UUID> {
    ...
    /**
     * Gets shuffle workers metrics.
     *
     * @return the shuffle workers metrics keyed by {@link InstanceID}.
     */
